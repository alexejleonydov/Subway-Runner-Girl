  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          col_1 = tmpvar_2;
          if(((in_f.xlv_COLOR.x<0.001) && (in_f.xlv_COLOR.z>0.001)))
          {
              float grey_3;
              float tmpvar_4;
              tmpvar_4 = (((tmpvar_2.x * 0.299) + (tmpvar_2.y * 0.587)) + (tmpvar_2.z * 0.114));
              grey_3 = tmpvar_4;
              float3 tmpvar_5;
              tmpvar_5.x = grey_3;
              tmpvar_5.y = grey_3;
              tmpvar_5.z = grey_3;
              col_1.xyz = float3(tmpvar_5);
          }
          else
          {
              col_1 = (col_1 * in_f.xlv_COLOR);
          }
          out_f.color = col_1;
          return out_f;
      }
