  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Vert vert(appdata_t in_v)
      {
          ...
          float _tmp_dvx_7 = clamp((((tmpvar_2.y / tmpvar_3.w) - _SkyGradientOffset) / (1 - _SkyGradientOffset)), 0, 1);
          tmpvar_1.xyz = lerp(_SkyGradientBottomColor.xyz, _SkyGradientTopColor.xyz, float3(_tmp_dvx_7, _tmp_dvx_7, _tmp_dvx_7));
          float _tmp_dvx_8 = clamp(((1000 - tmpvar_3.w) / 300), 0, 1);
          tmpvar_1.xyz = lerp(tmpvar_1.xyz, _FogSilhouetteColor.xyz, float3(_tmp_dvx_8, _tmp_dvx_8, _tmp_dvx_8));
