  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          main_1 = tmpvar_2;
          if(((tmpvar_2.w>0.99) && (_IsOpenFlowLight==1)))
          {
              float4 flowColor_3;
              float2 flowUV_4;
              float2 tmpvar_5;
              tmpvar_5.x = ((in_f.xlv_TEXCOORD0.x - _OffsetXRate) / _WidthRate);
              tmpvar_5.y = ((in_f.xlv_TEXCOORD0.y - _OffsetYRate) / _HeightRate);
              flowUV_4 = tmpvar_5;
              flowUV_4.x = (flowUV_4.x * 0.5);
              flowUV_4.x = (flowUV_4.x - _FlowLightOffset);
              float4 tmpvar_6;
              tmpvar_6 = (tex2D(_FlowLightTex, flowUV_4) * _FlowLightPower);
              flowColor_3.w = tmpvar_6.w;
              flowColor_3.xyz = (tmpvar_6.xyz * tmpvar_2.xyz);
              main_1.xyz = (tmpvar_2.xyz + flowColor_3.xyz);
