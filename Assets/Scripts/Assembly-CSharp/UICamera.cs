...
public class UICamera : MonoBehaviour
{
	...
	private void Update()
	{
		...
		if ((useKeyhelm || useController) && !disableController)
		{
			ProcessOthers();
		}
	...
	public void ProcessOthers()
	{
		...
		if (Input.anyKeyDown)
		{
			...
			for (int num3 = NGUITools.keys.Length; i < num3; i++)
			{
				...
				if (keyCode != keyCode2 && GetKeyDown(keyCode2) && (useKeyhelm || keyCode2 >= KeyCode.Mouse0) && (useController || keyCode2 < KeyCode.JoystickButton0) && (useMouse || (keyCode2 < KeyCode.Mouse0 && keyCode2 > KeyCode.Mouse6)))
				{
					currentKey = keyCode2;
					if (onKey != null)
					{
